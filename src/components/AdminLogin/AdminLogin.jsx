...
function AdminLogin() {
  ...
  const { signIn } = UserAuth();
    ...
    try {
     ...
     <Form onSubmit={handleSubmit} className="form">    <h1 className='mb-5 text-center'>Login</h1>
      <Form.Group className="mb-3" controlId="user">
        <Form.Label>Username</Form.Label>
        <Form.Control onChange={(e) => setEmail(e.target.value)} type="text" placeholder="Enter username" />
      </Form.Group>
